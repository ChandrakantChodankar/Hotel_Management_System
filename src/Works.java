...
public class Works extends javax.swing.JFrame {
    ...
    private void DisplayTable() {
        try {
            ...
            try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/hotelmanagementsystem", "root", "")) {
                String sql = "create or replace view WORKS as SELECT employee.employee_id , employee.employee_name, room.roomno , room.roomtype from employee,room where employee.roomno = room.roomno ";
   ...
   private void initComponents() {
        ...
        jLabel1.setText("EMPLOYEE-ROOM DETAILS");
